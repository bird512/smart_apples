...
class MessageResourceIT {
    ...
    private static final MessageLevel DEFAULT_LEVEL = MessageLevel.ERROR;
    private static final MessageLevel UPDATED_LEVEL = MessageLevel.INFO;
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().level(DEFAULT_LEVEL).msg(DEFAULT_MSG);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().level(UPDATED_LEVEL).msg(UPDATED_MSG);
        return message;
    }
    ...
    void createMessage() throws Exception {
        ...
        assertThat(testMessage.getMsg()).isEqualTo(DEFAULT_MSG);
    }
    ...
    void putExistingMessage() throws Exception {
        ...
        updatedMessage.level(UPDATED_LEVEL).msg(UPDATED_MSG);
        ...
        Message testMessage = messageList.get(messageList.size() - 1);
        assertThat(testMessage.getLevel()).isEqualTo(UPDATED_LEVEL);
        assertThat(testMessage.getMsg()).isEqualTo(UPDATED_MSG);
    }
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.level(UPDATED_LEVEL).msg(UPDATED_MSG);
