  ...
  return (
    <div>
      <h2 id="message-heading" data-cy="MessageHeading">
        <Translate contentKey="smartAppleApp.message.home.title">Messages</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="smartAppleApp.message.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/message/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="smartAppleApp.message.home.createLabel">Create new Message</Translate>
          </Link>
        </div>
      </h2>
        ...
        {messageList && messageList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="smartAppleApp.message.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="smartAppleApp.message.level">Level</Translate>
                </th>
                <th>
                  <Translate contentKey="smartAppleApp.message.msg">Msg</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {messageList.map((message, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`smartAppleApp.MessageLevel.${message.level}`} />
                  </td>
                  <td>{message.msg}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="smartAppleApp.message.home.notFound">No Messages found</Translate>
            </div>
          )
        )}
      </div>
