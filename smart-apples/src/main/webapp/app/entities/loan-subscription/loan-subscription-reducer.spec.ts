...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './loan-subscription.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANSUBSCRIPTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOANSUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOANSUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOANSUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOANSUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOANSUBSCRIPTION actions', async () => {
      const expectedActions = [
        {
