...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './loan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOAN actions', async () => {
      const expectedActions = [
        {
